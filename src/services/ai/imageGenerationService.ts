...
export class ImageGenerationService {
  ...
  static async generateStoryImages(options: ImageGenerationOptions): Promise<ImageGenerationResult> {
    ...
    try {
      ...
      // Strategy: Use prompts directly from database (generated by story AI)
      ...
      // Map image types to scene prompts from database
      ...
      // Generate images sequentially using AI-provided prompts
