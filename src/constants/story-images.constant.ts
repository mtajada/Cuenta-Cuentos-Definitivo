/**
 * DEPRECATED: SYSTEM_PROMPT_BASE is no longer used.
 * Image prompts are now generated by the story AI and stored in database as part of scenes.
 * This constant is kept for reference only and can be removed in future cleanup.
 * @deprecated Use AI-generated prompts from database (story.scenes) instead
 */
...
/**
 * Image type constants for story illustrations
 * These match the keys in StoryScenes interface
 */
export const IMAGES_TYPE = {
    ...
    SCENE_4: "scene_4",
    CLOSING: "closing",
    CHARACTER: "character", // Legacy, kept for backward compatibility
} as const;
