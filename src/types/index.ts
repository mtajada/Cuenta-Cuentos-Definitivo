...
/**
 * StoryScenes: AI-generated prompts for image generation
 * This structure is generated by the story AI and contains detailed prompts
 * for each image type, ensuring visual consistency across all illustrations
 */
export interface StoryScenes {
  character: string;     // Detailed visual description of main character(s)
  cover: string;         // Prompt for cover image
  scene_1: string;       // Prompt for first important scene
  scene_2: string;       // Prompt for second important scene
  scene_3: string;       // Prompt for third important scene
  scene_4: string;       // Prompt for fourth important scene
  closing: string;       // Prompt for closing image (back view)
}
